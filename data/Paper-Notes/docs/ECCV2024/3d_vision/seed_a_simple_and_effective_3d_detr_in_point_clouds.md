...
**代码**: [https://github.com/happinesslz/SEED](https://github.com/happinesslz/SEED)  
**领域**: 3D视觉  
...
2. **Deformable Grid Attention (DGA) — 可变形网格注意力**：
    ...
    - **功能**：在 SEED Decoder Layer 中替代标准 cross attention，利用 3D 物体几何信息进行有效的查询-BEV 交互
    - **核心思路**：
